...
# Test camera on GStreamer
gst-launch-1.0 -v v4l2src device=/dev/video0 ! video/x-bayer,format=grbg,depth=8,width=1920,height=1080,framerate=60/1,pixel-aspect-ratio=1/1 ! bayer2rgbneon ! ximagesink display=:0
# Press: Ctrl+C to abort

# Test camera on GStreamer with display FPS
gst-launch-1.0 -v v4l2src device=/dev/video0 ! video/x-bayer,format=grbg,depth=8,width=1920,height=1080,framerate=60/1,pixel-aspect-ratio=1/1 ! bayer2rgbneon ! fpsdisplaysink
# Press: Ctrl+C to abort
